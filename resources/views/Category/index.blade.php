                        ...
                        <table class="table table-bordered datatable">
                            ...
                            <tbody>
                                ...
                                <th scope="row">{{$i++}}</th>
                                    ...
                                    @if($cate->status == 'active')<td style="background-color:green">{{$cate->status}}</td>
                                    @else<td style="background-color:red">{{$cate->status}}</td> 
                                   @endif
                                    <td>
                                        ...
                                        <a href="javascript:;" class="btn btn-sm btn-danger sa-delete" data-form-id="category-delete-{{$cate->id}}">
